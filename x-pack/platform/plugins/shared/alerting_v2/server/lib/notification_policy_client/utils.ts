...
export const buildCreateNotificationPolicyAttributes = ({
  ...
  return {
    ...
    snoozedUntil: null,
    followMaintenanceWindows: data.followMaintenanceWindows ?? true,
    auth,
    createdBy,
    createdByUsername,
    createdAt,
...
export const buildUpdateNotificationPolicyAttributes = ({
  ...
  return {
    ...
    followMaintenanceWindows:
      update.followMaintenanceWindows ?? existing.followMaintenanceWindows ?? true,
    auth,
...
export const transformNotificationPolicySoAttributesToApiResponse = ({
  ...
  return {
    ...
    followMaintenanceWindows: attributes.followMaintenanceWindows ?? true,
